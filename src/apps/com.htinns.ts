      ...
      rules: [
        {
          ...
          action: 'clickCenter',
          actionMaximum: 1,
          matches: ['[desc="会员"][clickable=true][visibleToUser=true]'],
          excludeMatches: [
        ...
        },
        {
          ...
          action: 'clickCenter',
          actionMaximum: 1,
          matches: ['[desc^="签到"][clickable=true][visibleToUser=true]'],
          excludeMatches: ['[desc*="今日已签"]'],
        },
        {
          key: 3,
          preKeys: [2],
          ...
          actionDelay: 1000,
          actionMaximum: 1,
          anyMatches: ['[text="立即签到"]', '[text="签到开盲盒"]'],
        },
        {
          key: 4,
          preKeys: [3],
